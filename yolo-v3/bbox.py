...
def bbox_iou(box1, box2, xywh=False):
    """
    ...
    box1 = box1.data  # no_grad
    box2 = box2.data  # no_grad
    if xywh:
        b1_x1, b1_y1, b1_x2, b1_y2 = box1[:, 0]-box1[:, 2]/2, box1[:, 1] - \
            box1[:, 3]/2, box1[:, 0]+box1[:, 2]/2, box1[:, 1]+box1[:, 3]/2
        b2_x1, b2_y1, b2_x2, b2_y2 = box2[:, 0]-box2[:, 2]/2, box2[:, 1] - \
            box2[:, 3]/2, box2[:, 0]+box2[:, 2]/2, box2[:, 1]+box2[:, 3]/2
    else:
