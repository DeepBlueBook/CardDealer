...
def build_targets(pred_boxes, target, anchors, num_anchors, num_classes, nH, nW, noobject_scale, object_scale, sil_thresh, seen):
    ...
    for b in range(nB):
        ...
        for t in range(50):  # box number < 50,
            if target[b][t*5+1] == 0:
                break
    ...
    for b in range(nB):
        for t in range(50):
            ...
            #print("type(gt_box),type(pred_box)",type(gt_box),type(pred_box))
            #print("gt_box,pred_box.shape",gt_box,pred_box.shape)
            #print("target[b][t*5+1], nW", target[b][t*5+1], nW)
...
class RegionLoss(nn.Module):
    ...
    def forward(self, output, target):
        ...
        #print(pred_boxes.shape, target.shape, x.data.shape, grid_x.shape)
